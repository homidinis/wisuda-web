...
while ($row = mysqli_fetch_array($query)) {
    ...
    $pdf->Cell(5,10,'',$border,0,"L", true);
    $pdf->MultiCell(0,5,'Pengambilan konsumsi oleh 1 orang perwakilan undangan. Setiap wisudawan mendapat 1 paket konsumsi.','TLR',1, true);
    ...
    $pdf->Cell(5,10,'',$border,0,"L", true);
    $pdf->MultiCell(0,5,'Panduan lengkap prosesi wisuda dapat diakses di wisuda.unika.ac.id/?i='.$row['kodeunik'],'LBR',1, true);
