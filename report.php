...
echo "<div class='container' style='margin-top:10px; background:".$background."; padding:10px;'>"; //warna
	...
	echo '    </div>';
	echo '    <div class="col-md-3 form-group">';
	     echo "<a href='report.php?s=4&t=1' class='btn btn-info form-control' style='background-color:#5b7fde; color:orange;'>REPORT PRESENSI 4</a>";
	echo '    </div>';
	echo '  </div>';
	...
	echo '    <div class="col-md-3 form-group">';
	      echo "<a href='report.php?s=4&t=3' style='background-color:#5bdebb' class='btn btn-info form-control'>REPORT MAKAN 4</a>";
	echo '    </div>';
