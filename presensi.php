...
?>
	...
	<div class="container">
		<table class='table'>
			...
			<tr>
				...
				<td>
						<?php 
							include 'conn.php';
							$sql_pres_3 = "SELECT * FROM ".$prefix."t_presensi LEFT JOIN ".$prefix."t_wisudawan ON ".$prefix."t_presensi.nim = ".$prefix."t_wisudawan.nim WHERE sesi = 3 ORDER BY timestamp DESC";
				...
				<td>
						<?php 
							include 'conn.php';
							$sql_pres_4 = "SELECT * FROM ".$prefix."t_presensi LEFT JOIN ".$prefix."t_wisudawan ON ".$prefix."t_presensi.nim = ".$prefix."t_wisudawan.nim WHERE sesi = 4 ORDER BY timestamp DESC";
		...
		<?php
			$sql = "SELECT * FROM ".$prefix."t_presensi LEFT JOIN ".$prefix."t_wisudawan ON ".$prefix."t_presensi.nim = ".$prefix."t_wisudawan.nim ORDER BY timestamp DESC";
			$query = mysqli_query($conn, $sql); 
		?>
