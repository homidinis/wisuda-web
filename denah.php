...
<div class="container" style="margin-top: 10px;">
	<div class="row">
		<div class="col-md-6">
			<a href="denah.php?s=1" class="btn btn-info form-control">SESI 1</a>
		</div>
		<div class="col-md-6">
			<a href="denah.php?s=2" class="btn btn-info form-control">SESI 2</a>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-md-6">
			<a href="denah.php?s=3" class="btn btn-info form-control">SESI 3</a>
		</div>
	    <div class="col-md-6">
	        <a href="/admin/index.php" class="btn btn-danger form-control">Menu</a>
	    </div>
	</div>
</div>
<?php
...
$sql = "SELECT * FROM ".$prefix."t_wisudawan AS wisudawan LEFT JOIN ".$prefix."t_presensi AS presensi ON wisudawan.nim = presensi.nim WHERE sesi = '$sesi'";
...
<div style="width:100% ;overflow:auto">
	<h2 style="text-align: center;">Denah Sesi <?php echo $sesi;?></h2>
    <table style="text-align:center;padding:2px;margin:2px; border-spacing:5px 8px;background-color:<?php echo $background;?>;border-collapse:separate;border:1px 500158 solid;width: 100%;">
    <?php
        $i = 0;
        echo "<th colspan='17' style='background-color:".$background.";text-align:center;padding:5px'>SENATOR</th>";
