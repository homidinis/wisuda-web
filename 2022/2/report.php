...
$sql = "SELECT 
			...
			2022_2_t_wisudawan.prodi, 
			2022_2_t_wisudawan.nomorkursi, 
			2022_2_t_presensi.timestamp 
		FROM 
			2022_2_t_wisudawan LEFT JOIN 2022_2_t_presensi 
				ON 2022_2_t_wisudawan.nim = 2022_2_t_presensi.nim 
		ORDER BY 
			2022_2_t_wisudawan.id ASC";
$query = mysqli_query($conn, $sql);

echo "<div class='container' style='margin-top:50px;'>";
echo "<h1>Report Presensi Wisuda II 2022</h1>";
