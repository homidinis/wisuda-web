...
{
	$cek_duplicate = "SELECT * FROM 2022_2_t_ortu WHERE nim = '$nim'";
	$sql_insert = "INSERT INTO 2022_2_t_ortu (nim) VALUES ('$nim')";
	$query_duplicate = mysqli_query($conn, $cek_duplicate);
	if(mysqli_num_rows($query_duplicate)==0)
	{
		mysqli_query($conn, $sql_insert);
		header("Location: ortu.php?p=1");
	}
	else
	{
		header("Location: ortu.php?p=0");
