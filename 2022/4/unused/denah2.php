...
$sql = "SELECT * FROM ".$prefix."t_wisudawan AS wisudawan LEFT JOIN ".$prefix."t_presensi AS presensi ON wisudawan.nim = presensi.nim WHERE sesi = 2";
...
<div style="width:100% ;overflow:auto">
    <table style="text-align:center;padding:2px;margin:2px; border-spacing:5px 8px;background-color:#c80f0f;border-collapse:separate;border:1px 500158 solid">
    <?php
        $i = 0;
        echo "<th colspan='17' style='background-color:#c80f0f;text-align:center;padding:5px'>SENATOR</th>";
