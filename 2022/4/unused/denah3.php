...
$sql = "SELECT * FROM ".$prefix."t_wisudawan AS wisudawan LEFT JOIN ".$prefix."t_presensi AS presensi ON wisudawan.nim = presensi.nim WHERE sesi = 3";
...
<div style="width:100% ;overflow:auto">
    <table style="text-align:center;padding:2px;margin:2px; border-spacing:5px 8px;background-color:#f1a914;border-collapse:separate;border:1px 500158 solid">
    <?php
        $i = 0;
        echo "<th colspan='17' style='background-color:#f1a914;text-align:center;padding:5px'>SENATOR</th>";
